...
from drivers.igus_driver.exceptions import FaultState, OperationTimeout
from drivers.igus_driver.od import ODKey
from drivers.igus_driver.state_bits import (
    DriveState,
    parse_drive_state,
    Statusword,
...
class DriveStateMachine:
    ...
    def __init__(self, sdo, poll_delay=1, timeout=5.0, parse_drive_state_fn=None):
        ...
        from drivers.igus_driver.state_bits import parse_drive_state as default_parser
