...
from drivers.igus_scripts.igus_motor_command_builder import MotorCommandBuilder
import drivers.igus_scripts.igus_checkers as checkers
...
# Update all functions to use the driver instance
